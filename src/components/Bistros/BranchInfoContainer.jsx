...
import BranchIcon from "../../assets/business-center.png"
...
function BranchInfoContainer({branch}) {
    return (
        <div className={Style.bistroInfoCard}>
            <div className={`${Style.flexCenter} ${Style.bistroInfohead} `}>
                <div className={`${Style.flex} ${Style.flexOne}  `} >
                    <Icon id={`${Style.Icon}`} src={BranchIcon}></Icon>
                    <div className={`${Style.flex} ${Style.flexCenter} ${Style.bgRed}`}>
                        <h1 className={`${Style.nameTitle}`}>{branch.branchName}</h1>
                    </div>
                </div>
            ...
            <div className={Style.infoContainer}>
                <div className={Style.infoDiv}>
                    ...
                    <div className={Style.infoInnerDiv}>
                        <span className={Style.infoTittle}>BISTRO NAME</span>
                        <span className={Style.infoValue}>{branch.bistroName}</span>
                    </div>
                </div>    <div className={Style.infoDiv}>
                    <Icon src={Document}></Icon>
                    <div className={Style.infoInnerDiv}>
                        <span className={Style.infoTittle}>LOCATION TAG</span>
                        <span className={Style.infoValue}>Kharghar
